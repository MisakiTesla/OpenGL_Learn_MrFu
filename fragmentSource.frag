...
void main()
{
	...
	{
		//middle
		//spotRatio = 1 - (cosTheta - lightSpot.cosPhyInner) / (lightSpot.cosPhyOutter - lightSpot.cosPhyInner);
		spotRatio = (cosTheta - lightSpot.cosPhyOutter)/(lightSpot.cosPhyInner - lightSpot.cosPhyOutter);
	}
	else
	{
		spotRatio = 0;
